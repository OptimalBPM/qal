...
class ClassSQLMetaJSONTest(unittest.TestCase):
    ...
    def test_9_resource(self):
        ...
        _dict_cmp_data = [
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'AUD      ', '29.1358 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'BND      ', '24.3550 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'CAD      ', '29.9598 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'CHF      ', '34.4377 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'CNY      ', '5.0313 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'DKK      ', '5.6530 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'EUR      ', '42.2219 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'GBP      ', '50.0854 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'HKD      ', '3.9914 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'IDR      ', '2.4461 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'INR      ', '0.4485 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'JPY      ', '31.8058 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'MYR      ', '9.6064 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'NOK      ', '5.1948 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'NZD      ', '25.6424 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'PHP      ', '0.6994 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'PKR      ', '0.2809 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'SEK      ', '4.8697 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'SGD      ', '24.7693 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00'],
            [1, 1, 'DataPostgres', 'DataMySQL', 'csv', 'USD      ', '31.0644 ', 'MSXML3: A Comprehensive Guide', 36.95, b'file_csvID,file_csvName,file_csvChanged\n1,csv,2001-01-01 00:00:00\n2,csv,2001-01-02 00:00:00']
        ]
        print("Data:")
        for _row in _rows:
            print(str(_row))
