...
def sql_property_to_type(_property_name, _json_ref = None):
    ...
    if _property_name in ["name", "default", "tablename", "alias", "default", "operator",
                          ...
                          "quotechar", "skipinitialspace", "escapechar", "lineterminator", "sheet_name", "table_name",
                          "query"]:
        return ["string"]

    elif _property_name in ["numeric_value"]:
    ...
    elif _property_name in ["top_limit", "x_offset", "y_offset"]:
        return ["integer"]
    ...
    elif _property_name in ["column_names", "field_names", "field_xpaths"]:
