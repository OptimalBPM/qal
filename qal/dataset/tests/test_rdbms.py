...
class Test(unittest.TestCase):
    ...
    def _test_1_Load_Save(self, _has_header = None, _resource = None):
        ...
        self.assertEqual(_d_dest.data_table,  [[1, 'source', datetime.datetime(2001, 1, 1, 0, 0)], [2, 'source', datetime.datetime(2001, 1, 2, 0, 0)], [3, 'source_new', datetime.datetime(2014, 1, 1, 0, 0)]], "Results differ")
