...
class Diff_test(unittest.TestCase):
    ...
    def test_diff(self):
        ...
        self.assertEqual(_missing_left, [[1, 12, ['7999', 'BORJESSON', 'HACKER', '7839', '2013-01-01', '99999', '', '10']]], 'Missing left differs')
        ...
        self.assertEqual(_difference, [[0, 0,['7369', 'SMITH', 'CLERK', '7902', '1980-12-17 00:00:00', '800', '', '20'], 
                                       ...
                                       [10, 8,['7876', 'ADAMS', 'CLERK', '7788', '1983-01-12 00:00:00', '1100,5', '', '20'], 
